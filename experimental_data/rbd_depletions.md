...
![png](rbd_depletions_files/rbd_depletions_24_0.png)
...
![png](rbd_depletions_files/rbd_depletions_26_1.png)
...
![png](rbd_depletions_files/rbd_depletions_27_1.png)
...
```
    ...
    Comparing first/convalescent to first/vaccine
      Mann-Whitney test:      P = 6.6e-05
      Log-rank test:          P = 3.1e-05
      Log-rank test censored: P = 8.4e-07
    ...
    Comparing first/convalescent to last/vaccine
      Mann-Whitney test:      P = 0.00022
      Log-rank test:          P = 0.00091
      Log-rank test censored: P = 1.3e-05
    Comparing first/vaccine to last/convalescent
      Mann-Whitney test:      P = 9e-05
      Log-rank test:          P = 1.9e-05
      Log-rank test censored: P = 0.071
    ...
    Comparing last/convalescent to last/vaccine
      ...
      Log-rank test censored: P = 0.14



![png](rbd_depletions_files/rbd_depletions_29_1.png)
...
![png](rbd_depletions_files/rbd_depletions_43_0.png)
...
```
    ...
    [NbConvertApp] Making directory rbd_depletions_files
    [NbConvertApp] Making directory rbd_depletions_files
    [NbConvertApp] Writing 31428 bytes to rbd_depletions.md
